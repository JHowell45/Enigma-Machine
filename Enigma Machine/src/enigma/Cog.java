...
public class Cog {
	 ...
	 *         This means that they each take it in turn to rotate. Once the smallest cog 
	 *         has done a full rotation the next cog does one rotation and they all follow the 
	 *         same pattern.
	 */
